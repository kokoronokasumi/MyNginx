...
ngx_init_cycle(ngx_cycle_t *old_cycle)
{
    ...
    //sizeof(ngx_path_t *)是指针8个字节，所以长度是n,内存大小是n*8
    ...
    for (i = 0; cycle->modules[i]; i++) {
        ...
        //判断是否youcreate_conf方法
        //其实就是nginx.c中的ngx_core_module_create_conf方法
    ...
    //创建临时变量池
    //大小为NGX_CYCLE_POOL_SIZE=16*1024
